...
def main() : 
	...
	for img in imgs:
		...
		for i in range(len(circle_props)):
			print(i)
			circles.append(cv.HoughCircles(gray, cv.HOUGH_GRADIENT, 1, 200, param1=130, param2=50, minRadius=int(max_rad*circle_props[i])-20, maxRadius=int(max_rad*circle_props[i])+20)[0][0])
